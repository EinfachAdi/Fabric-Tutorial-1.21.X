...
public class ModVillagers {
    public static final RegistryKey<PointOfInterestType> NETHERALD_POI_KEY = registerPoiKey("netherald_poi");
    public static final PointOfInterestType NETHERALD_POI = registerPOI("netherald_poi", ModBlocks.NETHER_EMERALD_GHOST_BLOCK);
